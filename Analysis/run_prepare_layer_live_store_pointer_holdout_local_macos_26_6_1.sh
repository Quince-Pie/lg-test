...
# Run the frozen unseen-geometry last-store holdout on the active Retina M1.
...
readonly capture=Analysis/capture_prepare_layer_crop_policy_holdout_live_local_macos_26_6_1_lldb.py
readonly transport=Analysis/prepare_layer_live_transport_local_macos_26_6_1.py
readonly validator=Analysis/validate_prepare_layer_live_store_pointer_holdout_local_macos_26_6_1.py
readonly preregistration=Analysis/prepare_layer_live_store_pointer_holdout_local_macos_26_6_1_preregistration.json
readonly calibration=Analysis/prepare_layer_live_transport_d439d53_calibration_result.json
readonly preflight=Analysis/check_local_retina_capture_session_v2.swift
readonly output_directory="local-prepare-layer-live-store-pointer-holdout-${run_label}"
...
require_sha256 "$validator" ae6a7527e4708459c761dd3a488539c1f63e914bd871fe2040d83569f4d7ec75
require_sha256 "$preregistration" 55322fcd42b49608c92d53dbde43eb7948e4072862092277af7735845e3292b2
require_sha256 "$calibration" 2939ee106bdebd362ef3c699cd660e78e7d1f98a2b1d5a44e2c2a745129f24e8
...

{
    ...
    /usr/bin/shasum -a 256 \
        "$binary" "$capture" "$transport" "$validator" \
        "$preregistration" "$calibration" "$preflight"
...
/usr/bin/env "${capture_environment[@]}" \
    ...
    -o continue \
    -o "script import capture_prepare_layer_crop_policy_holdout_live_local_macos_26_6_1_lldb as live_capture; live_capture.finalize()" \
    -o quit \
