...
# Execute the frozen unseen circle-496 v3 crop transfer on the Retina M1.
...
readonly validator=Analysis/validate_prepare_layer_live_crop_replay_v3_holdout_local_macos_26_6_1.py
readonly preregistration=Analysis/prepare_layer_live_crop_replay_v3_holdout_local_macos_26_6_1_preregistration.json
readonly preflight=Analysis/check_local_retina_capture_session_v2.swift
readonly output_directory="local-prepare-layer-live-crop-replay-v3-holdout-${run_label}"
...
require_sha256 "$validator" e56d139e826d61ed57b16f605ff63b8b6ab29215004362c4f8360e1238fbbaf3
require_sha256 "$preregistration" 4ceab97059a3c9e77fe45269a2a39e37adc312278de5ebdae59816a252c3f0d2
