...
# Run a frozen clear-writer/removal case on the active physical Retina M1.
...
readonly preregistration=Analysis/backdrop_margin_writer_clear_presentation_removal_local_macos_26_6_1_preregistration.json
readonly validator=Analysis/validate_backdrop_margin_writer_clear_presentation_removal_local_macos_26_6_1.py
readonly runner=Analysis/run_backdrop_margin_writer_clear_presentation_removal_local_macos_26_6_1.sh
readonly output_directory="local-backdrop-margin-clear-removal-${run_label}"
