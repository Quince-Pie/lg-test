...
# Run the five-stop immediate-return join directly on the local M1 Retina Mac.
...
readonly capture=Analysis/capture_background_filter_constructor_timeline_marker_return_join_local_macos_26_6_1_lldb.py
readonly preflight=Analysis/check_local_retina_capture_session_v2.swift
readonly preregistration=Analysis/background_filter_constructor_timeline_marker_return_join_local_macos_26_6_1_preregistration.json
readonly validator=Analysis/validate_background_filter_constructor_timeline_marker_return_join_local_macos_26_6_1.py
readonly runner=Analysis/run_background_filter_constructor_timeline_marker_return_join_local_macos_26_6_1.sh
readonly predecessor_failure=Analysis/background_filter_constructor_timeline_marker_direct_join_7d2f8ab_failure_result.json
readonly output_directory="local-background-filter-constructor-timeline-marker-return-join-${run_label}"
readonly trace="$repository/$output_directory/background-filter-direct-join-trace.json"
...
require_sha256 "$capture" d0af920027d06500a46cb82e8bd60a9b9e2891dfad0478777dc35f0dfd88eacb
require_sha256 "$preflight" f12a1cbe29629dc843cc3250a46fa686225f3c08bcf1bf1dbdf50aea913926f1
require_sha256 "$validator" 4db2cd6c8bedcfb33d2e63cf05fc3c273f62c34e85dd4de4de5ad2775ae27f76
require_sha256 "$predecessor_failure" b9aaccf97ee9883ee532551909a81b171c5a69315c8b34193157fc3d042cb1ea
...
/usr/bin/env \
    "${common_environment[@]}" \
    LG_BACKGROUND_FILTER_CONSTRUCTOR_TIMELINE_MARKER_DIRECT_JOIN_TRACE_OUTPUT="$trace" \
    "$lldb" -b \
    ...
    -o continue \
    -o "script import capture_background_filter_constructor_timeline_marker_return_join_local_macos_26_6_1_lldb as returned; returned.finalize()" \
    -o quit \
