...
# Run the four-stop live direct join on the local M1 Retina Mac with Apple CLT.
...
readonly capture=Analysis/capture_background_filter_constructor_timeline_marker_direct_join_local_macos_26_6_1_lldb.py
readonly preflight=Analysis/check_local_retina_capture_session_v2.swift
readonly preregistration=Analysis/background_filter_constructor_timeline_marker_direct_join_local_macos_26_6_1_preregistration.json
readonly validator=Analysis/validate_background_filter_constructor_timeline_marker_direct_join_local_macos_26_6_1.py
readonly runner=Analysis/run_background_filter_constructor_timeline_marker_direct_join_local_macos_26_6_1.sh
readonly census_failure=Analysis/background_filter_constructor_timeline_marker_census_69fe692_failure_result.json
readonly output_directory="local-background-filter-constructor-timeline-marker-direct-join-${run_label}"
...
require_sha256 "$capture" 14d6ea6368f9ff6766821d5b516afebeae00dc5d9ae9646532c9b7e716e4b573
require_sha256 "$preflight" f12a1cbe29629dc843cc3250a46fa686225f3c08bcf1bf1dbdf50aea913926f1
require_sha256 "$validator" 2273638e6e176f5b4f5453e0db5d0f9844ecac813d3849b02ac9b1b5ca09c929
require_sha256 "$census_failure" e1bbf34f361434497a94312b03da744e869bc0131f2de82d12d6cdb088946a8d
...
/usr/bin/env \
    ...
    -o continue \
    -o "script import capture_background_filter_constructor_timeline_marker_direct_join_local_macos_26_6_1_lldb as direct; direct.finalize()" \
    -o quit \
