#!/usr/bin/env python3
"""Source checks for the regular-material FilterOp trace adapter."""
...
SOURCE_PATH = ANALYSIS_ROOT / "capture_prepare_layer_filter_map_bounds_regular_lldb.py"
...
class PrepareLayerFilterMapBoundsRegularSourceTests(unittest.TestCase):
    @classmethod
    ...
    def test_geometry_is_configured_before_frozen_initialization(self) -> None:
        self.assertIn('EXPECTED_GEOMETRY = "circle-800-center"', self.source)
    ...
    def test_adapter_adds_no_capture_mechanism(self) -> None:
        for token in (
            "BreakpointCreate",
            "WatchAddress",
            "ReadMemory",
