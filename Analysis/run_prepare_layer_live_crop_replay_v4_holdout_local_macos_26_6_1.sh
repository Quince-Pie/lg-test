...
# Execute the frozen runtime-unseen circle-498 v4 crop transfer on the Retina M1.
...
readonly validator=Analysis/validate_prepare_layer_live_crop_replay_v4_holdout_local_macos_26_6_1.py
readonly preregistration=Analysis/prepare_layer_live_crop_replay_v4_holdout_local_macos_26_6_1_preregistration.json
readonly preflight=Analysis/check_local_retina_capture_session_v2.swift
readonly output_directory="local-prepare-layer-live-crop-replay-v4-holdout-${run_label}"
...
require_sha256 "$validator" aa3f5846f060ddaf081d89627aef77366cca99f7472cd13113a0b7e5e235d051
require_sha256 "$preregistration" 4bddc2d722bdd0b96db32fd4d989cb22a457d4c3196ee17360d017e9fb16e47c
