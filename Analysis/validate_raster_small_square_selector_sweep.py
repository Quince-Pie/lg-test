#!/usr/bin/env python3
"""Resolve the Walle-size square AGX reciprocal-selector calibration."""

from pathlib import Path

import validate_raster_square_selector_sweep as sweep


sweep.RIG_VERSION = "metal-raster-small-square-selector-sweep-1.0.0"
sweep.ROLE = "walle-small-square-fixed-grid-reciprocal-selector-calibration"
sweep.PREREGISTRATION = Path(__file__).with_name(
    "raster_small_square_selector_sweep_preregistration.json"
)
...
sweep.CASE_COUNT = sweep.WIDTH_FIXED_UPPER - sweep.WIDTH_FIXED_LOWER + 1
