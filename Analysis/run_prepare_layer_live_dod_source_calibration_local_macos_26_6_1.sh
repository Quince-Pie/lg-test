...
# Measure live DOD source rectangles on the already-opened circle-485 trace.
...
readonly capture=Analysis/capture_prepare_layer_live_dod_source_bounds_local_macos_26_6_1_lldb.py
...
readonly validator=Analysis/validate_prepare_layer_live_dod_source_capture_local_macos_26_6_1.py
readonly preflight=Analysis/check_local_retina_capture_session_v2.swift
readonly output_directory="local-prepare-layer-live-dod-source-calibration-${run_label}"
...
require_sha256 "$capture" 9b40b09ed71e2432847c7f02573fde46ad9c30fc96111dd24fff3a9af3230479
...
require_sha256 "$validator" 7fda7505e9bb37aa46340417a518dac2bf8f8d79698e97ca923f95edefaa957e
...

{
    ...
    /usr/bin/shasum -a 256 \
        "$binary" "$capture" "$live_capture" "$transport" \
        "$validator" "$preflight"
...
/usr/bin/env "${capture_environment[@]}" \
    ...
    -o continue \
    -o "script import capture_prepare_layer_live_dod_source_bounds_local_macos_26_6_1_lldb as dod_capture; dod_capture.finalize()" \
    -o quit \
