#!/usr/bin/env python3
"""Source contracts for the frozen unseen v2 live crop holdout."""
...
import validate_prepare_layer_live_crop_replay_v2_holdout_local_macos_26_6_1 as validator


SOURCE = Path(validator.__file__).read_text(encoding="utf-8")
PREREGISTRATION_PATH = Path(__file__).with_name(
    "prepare_layer_live_crop_replay_v2_holdout_local_macos_26_6_1_preregistration.json"
)


class PrepareLayerLiveCropReplayV2HoldoutTests(unittest.TestCase):
    def test_holdout_profile_is_fixed_and_previously_unopened(self) -> None:
        self.assertEqual(validator.EXPECTED_GEOMETRY, "circle-487-center")
