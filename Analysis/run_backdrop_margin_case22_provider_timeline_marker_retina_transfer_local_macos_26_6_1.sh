...
# Run the frozen active-Retina last-call/provider transfer with Apple CLT only.
...
readonly capture=Analysis/capture_backdrop_margin_case22_provider_timeline_marker_transfer_local_macos_26_6_1_lldb.py
readonly preflight=Analysis/check_local_retina_capture_session_v2.swift
readonly preregistration=Analysis/backdrop_margin_case22_provider_timeline_marker_retina_transfer_local_macos_26_6_1_preregistration.json
readonly validator=Analysis/validate_backdrop_margin_case22_provider_timeline_marker_retina_transfer_local_macos_26_6_1.py
readonly runner=Analysis/run_backdrop_margin_case22_provider_timeline_marker_retina_transfer_local_macos_26_6_1.sh
readonly failure_result=Analysis/backdrop_margin_case22_provider_timeline_marker_28817f3_failure_result.json
readonly output_directory="local-case22-provider-timeline-marker-retina-transfer-${run_label}"
...
require_sha256 "$validator" 574c671f1c61a519365f724c1481d1c12c53a0b0cb13bb9351a0d0a3f5d835cd
require_sha256 "$failure_result" f01ae11f8f1ff47ca2eb80648618eb989f39c266f86caed9b6925548298c02f4
