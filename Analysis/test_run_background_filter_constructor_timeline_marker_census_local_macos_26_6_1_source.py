#!/usr/bin/env python3
"""Source contracts for the direct M1 producer-census shell script."""
...
SOURCE_PATH = (
    ...
    / "run_background_filter_constructor_timeline_marker_census_local_macos_26_6_1.sh"
)
SOURCE = SOURCE_PATH.read_text(encoding="utf-8")


class ConstructorTimelineMarkerCensusRunnerTests(unittest.TestCase):
    ...
    def test_native_capture_has_no_nix_store_path(self) -> None:
    ...
    def test_preflight_and_exact_main_bootstrap_precede_capture(self) -> None:
    ...
    def test_runner_is_local_and_not_github_actions(self) -> None:
        self.assertIn("local M1 Retina Mac", SOURCE)
