...
# Execute the frozen unseen circle-487 v2 crop transfer on the Retina M1.
...
readonly validator=Analysis/validate_prepare_layer_live_crop_replay_v2_holdout_local_macos_26_6_1.py
readonly preregistration=Analysis/prepare_layer_live_crop_replay_v2_holdout_local_macos_26_6_1_preregistration.json
readonly preflight=Analysis/check_local_retina_capture_session_v2.swift
readonly output_directory="local-prepare-layer-live-crop-replay-v2-holdout-${run_label}"
...
require_sha256 "$validator" 708f9907c6a187d44a566105bea7c8216d2687095fb74798ed7a7a7d3aa6b8a4
require_sha256 "$preregistration" 3a2cdd236e46169810a7bf89866a640b6f8c254db8ed8d62efa08b80c5ca3b36
...
readonly -a capture_environment=(
    ...
    LG_GLASS_GEOMETRY=circle-487-center
