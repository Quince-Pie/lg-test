"""Trace the frozen FilterOp selector on regular material at 800 points.

The underlying selector, instruction scopes, byte ranges, and stepping rules
are unchanged.  This adapter only sets the already supported geometry guard
and exposes callback names at LLDB's top-level Python module.
