#!/usr/bin/env python3
"""Source contract for the frozen direct-M1 v2 crop holdout executor."""
...
SOURCE = (
    Path(__file__)
    .with_name("run_prepare_layer_live_crop_replay_v2_holdout_local_macos_26_6_1.sh")
    .read_text(encoding="utf-8")
)


class RunPrepareLayerLiveCropReplayV2HoldoutTests(unittest.TestCase):
