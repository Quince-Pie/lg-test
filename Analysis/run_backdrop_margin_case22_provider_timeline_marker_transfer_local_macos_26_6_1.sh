...
# Run the frozen live-timeline/provider join with Apple's Command Line Tools.
# The native capture contains no Nix store path.
...
readonly preregistration=Analysis/backdrop_margin_case22_provider_timeline_marker_transfer_local_macos_26_6_1_preregistration.json
readonly validator=Analysis/validate_backdrop_margin_case22_provider_timeline_marker_transfer_local_macos_26_6_1.py
readonly runner=Analysis/run_backdrop_margin_case22_provider_timeline_marker_transfer_local_macos_26_6_1.sh
readonly output_directory="local-case22-provider-timeline-marker-transfer-${run_label}"
