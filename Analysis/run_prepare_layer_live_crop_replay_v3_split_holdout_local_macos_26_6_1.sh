...
# Execute the frozen unseen circle-497 split-criterion v3 crop transfer.
...
readonly validator=Analysis/validate_prepare_layer_live_crop_replay_v3_split_holdout_local_macos_26_6_1.py
readonly preregistration=Analysis/prepare_layer_live_crop_replay_v3_split_holdout_local_macos_26_6_1_preregistration.json
readonly preflight=Analysis/check_local_retina_capture_session_v2.swift
readonly output_directory="local-prepare-layer-live-crop-replay-v3-split-holdout-${run_label}"
...
require_sha256 "$validator" 507b97d7ec76e20312fb89052b6018fd86261a064f7bef68bb28a1289760326e
require_sha256 "$preregistration" 2b7958c6586c1c774b452204fdb31a1aaaa99e8905cab5e6ef1a188b3dc43510
