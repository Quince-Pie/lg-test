...
# Execute the frozen runtime-unseen circle-499 v5 crop transfer on the Retina M1.
...
readonly validator=Analysis/validate_prepare_layer_live_crop_replay_v5_holdout_local_macos_26_6_1.py
readonly preregistration=Analysis/prepare_layer_live_crop_replay_v5_holdout_local_macos_26_6_1_preregistration.json
readonly preflight=Analysis/check_local_retina_capture_session_v2.swift
readonly output_directory="local-prepare-layer-live-crop-replay-v5-holdout-${run_label}"
...
require_sha256 "$validator" abdae9d8750189aa6478dd37ee3cc3c219fd5162242d88dca58ea10594e7fa92
require_sha256 "$preregistration" fbcf03a1cf751802e0a515da4f0bde5ad48f52fc63f9d3ca558ec0538dd33cd6
