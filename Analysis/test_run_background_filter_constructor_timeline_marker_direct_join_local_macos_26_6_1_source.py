#!/usr/bin/env python3
"""Source contracts for the direct M1 four-stop join shell script."""
...
SOURCE_PATH = (
    ...
    / "run_background_filter_constructor_timeline_marker_direct_join_local_macos_26_6_1.sh"
)
SOURCE = SOURCE_PATH.read_text(encoding="utf-8")


class DirectJoinRunnerSourceTests(unittest.TestCase):
    ...
    def test_exact_main_bootstrap_and_preflight_are_ordered(self) -> None:
